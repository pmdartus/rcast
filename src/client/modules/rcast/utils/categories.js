...
export default [
    { id: 1301, name: 'Arts', iconName: 'brush' },
    ...
    { id: 1315, name: 'Science & Medicine', iconName: 'atom' },
    { id: 1316, name: 'Sports & Recreation', iconName: 'soccer' },
    { id: 1318, name: 'Technology', iconName: 'computer' },
    { id: 1321, name: 'Business', iconName: 'briefcase' },
    { id: 1323, name: 'Games & Hobbies', iconName: 'gamepad' },
    { id: 1324, name: 'Society & Culture', iconName: 'chart' },
    { id: 1325, name: 'Government & Organizations', iconName: 'badge' },
